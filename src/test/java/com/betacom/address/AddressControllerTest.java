...
public class AddressControllerTest {
    ...
    void testCreate_Success() throws Exception {
        doNothing().when(addressS).create(any());
    ...
    void testCreate_Error() throws Exception {
        ...
        AddressCreateRequest request = AddressCreateRequest.builder().build();
    ...
    void testFindById_Success() throws Exception {
        ...
        mockMvc.perform(get("/rest/address/findById/1"))
                .andExpect(status().isOk());
    }

    @Test
    void testFindById_Error() throws Exception {
        when(addressS.getById(anyLong()))
                .thenThrow(new RuntimeException("ID non trovato"));
